    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="mainContent">
                <h2 class="title">List of Vaccine Test</h2>
                <table>
                    <thead>
                        <tr>
                            <th>Id</th>
                        ...
                        <?php
                            ...
                            foreach($result as $row)
                            {
                                ...
                                "<tr>
                                    ...
                                    <td>$row[pname]</td>
                                    <td>
                                    $row[result]&nbsp&nbsp&nbsp;
                                    <a href='positive_result.php?id=$row[id]' class='btnactivate'>Positive</a>&nbsp;
                                    <a href='negative_result.php?id=$row[id]' class='btndeactivate'>Negative</a>
                                    </td>
